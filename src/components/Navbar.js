  ...
  return (
    <div className='position-absolute d-flex justify-content-center w-100' style={{zIndex:'999'}}>
      ...
      <div className='col-3 p-3' style={{borderRight:'1px solid #EAFC88', borderLeft:'1px solid #EAFC88'}}>
        <a href='#aboutsec' className='nav-title'>BERK SARIMEŞE</a>
      </div>
      ...
      <div className='col-3' style={{borderLeft:'1px solid #EAFC88',borderRight:'1px solid #EAFC88'}}>
        <div className='d-flex flex-column align-items-start p-3'>
          <a rel="noopener noreferrer" href='https://www.linkedin.com/in/berk-sar%C4%B1me%C5%9Fe-8b4a9a234/' target="_blank" className='nav-item'>LINKED-IN</a>
          <a rel="noopener noreferrer" href='https://github.com/berksarimese' target="_blank" className='nav-item'>GITHUB</a>
          <a rel="noopener noreferrer" href='https://www.instagram.com/berksarimese/' target="_blank" className='nav-item'>SOCIAL</a>
          <a href='#contactsec' className='nav-item'>CONTACT</a>
        </div>
      </div>
      </div>
    </div>
