 ...
 function Return(props) {
  ...
  return (
    <div className={`position-fixed d-flex justify-content-center w-100 ${makeVisible ? '' : 'd-none'}`}  style={{bottom:'5px', zIndex:'999'}}>
      ...
      <a href='#aboutsec' className='nav-title text-center' style={{borderBottom:'solid 1px #EAFC88', background: 'rgba(0, 0, 0, 0.3)'}}>{makeVisible}GO BACK TO START</a>
      </div>     
      ...
      <div className={`position-fixed px-1 py-2 noselect burger ${burger ? 'burger-open' : ''}`}>
        ...
        <a href='#contactsec' className='burger-item'>CONTACT</a>
        <div className='burger-item' />
        <a rel="noopener noreferrer" href='https://www.linkedin.com/in/berk-sar%C4%B1me%C5%9Fe-8b4a9a234/' target="_blank" className='burger-item'>LINKED IN</a>
        <a rel="noopener noreferrer" href='https://github.com/berksarimese' target="_blank" className='burger-item'>GITHUB</a>
        <a rel="noopener noreferrer" href='https://www.instagram.com/berksarimese/' target="_blank" className='burger-item'>SOCIAL</a>
